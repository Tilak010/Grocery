  ...
  return (
    <footer className="bg-app-green text-white">
       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          {/* TOP */}
          <div className="grid grid-cols-1 md:grid-cols lg:grid-cols-2 lg:grid-cols-4 gap-8">
             {/* Brand */}
             <div>
             ...
             <div className="flex gap-3">
               {footerData.brand.socials.map((social, i)=>(
                <a key={i} href="social.link" className="size-9 rouded-lg bg-white/10 flex-center hover:bg-white/2"><social.icon 
                className="size-4"/></a>
               ))}
             </div>
           </div>
