...
const FlashDeals = () => {
  ...
  return (
    <div className="min-h-screen bg-app-cream">
      ...
      {/* Banner */}
     <div className="bg-gradient-to-r from-app-orange to-app-orange to-app-orange-dark text-white py-10">
       <div className="flex-center gap-2 mb-3">
            <Zap className="flex-center gap-2 mb-3"/>
            <h1 className="text-3xl font-semibold text-center">Flash Deals</h1>
