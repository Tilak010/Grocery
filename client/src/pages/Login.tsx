           ...
           <div className="hidden lg:flex lg:w-1/2 bg-app-green relative items-center
            ...
            <img src={heroSectionData.hero_image} alt="" className="absolute inset-0 w-full h-full object-cover opacity-10"/>
             <div className="relative text-center px-12">
              ...
              Fresh groceries and organic produce, delivered to your door step</p>
             </div>
           </div>

          {/*Right Side*/}
          <div className="flex-1 flex-center px-4 py-12 bg-app-cream">
            <div className="w-flex max-w-md">
                  {/*form header message */}
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                     {!isLoginState && (
                      <label className="text-sm flex flex-col gap-1">
                        ...
                        <div className="relative">
                           ...
                           className="w-full pl-11 pr-4 py-3 text-sm bg-white rounded-xl border border-app-border
                     ...
                     <label className="text-sm flex flex-col gap-1">
                      ...
                      font-semibold rounded-xl hover:gb-green-900 transition-colors disabled:opacity-50">
                             {loading ? <Loader2Icon className="animate-spin"/> :
                             isLoginState ? "Sing In": "Sign Up"}
                      </button>
                  </form>
            </div>
          </div>
